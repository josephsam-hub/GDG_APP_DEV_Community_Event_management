...
class DropdownFormField<T> extends StatefulWidget {
  ...
  ///  [item] = [dynamic value] List item to build dropdown List tile
  ...
  /// [onTap] = [Function] *important! just assign this function to List tile.onTap  = onTap, in case you missed this,
...
class DropdownFormFieldState<T> extends State<DropdownFormField>
  ...
  _selectedFn(dynamic item1, dynamic item2) => item1 == item2;
          ...
          child: Material(
              ...
              shape: const RoundedRectangleBorder(
                borderRadius: BorderRadius.all(
                    Radius.circular(RadiusManager.fieldRadius)),
              ),
              child: SizedBox(
